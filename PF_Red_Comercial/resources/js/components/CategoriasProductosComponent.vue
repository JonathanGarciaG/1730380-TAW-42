            ...
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <div>Lista de Categorías de Productos
                        </div>
                    </div>
                </div>
            </div>             
            <div class="row">
                <div class="col-md-12">
                    <div class="main-card mb-3 card">
                        <div class="card-header">Categorías de Productos
                        </div>
                                        ...
                                        <div class="widget-content p-0">
                                            <div class="widget-content-wrapper">                                  
                                                <div class="widget-content-left flex2">
                                                    <div class="widget-heading">{{ cat.nombre_categoria }}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
...
<script>
    export default {
        ...
        mounted() {
            ...
            let me = this;
            let url = './categoriasp' //url que retorna los registros de la tabla categorias de productos
        ...
        methods: {
            ...
            newCategoria() {
                ...
                //se hace un request post con el url /categoriasp para que con su respuesta se realice la insercion
                axios.post('./categoriasp', params)
                    .then((response) => {
            ...
            camposUpdate(data){
                ...
                this.update = data.id;
                let me = this;
                let url = './categoriasp/'+this.update;
                axios.get(url).then(function (response){
                    me.nombre = response.data.nombre_categoria;
                }).catch(function (error){
                    console.log(error);
                });
            },
            ...
            reloadData(){
                let me = this;
                let url = './categoriasp' //url que retorna los registros de la tabla categorias
                axios.get(url).then(function (response) {
                    me.cats = response.data;
                })
                .catch(function (error) {
