...
<head>
	...
	<!-- Bootstrap-wyslw -->
	<link rel="stylesheet" type="text/css" href="{{ asset('css/prettify.min.css') }}">
	<!-- Select2 -->
	...
	<!-- fullcalendar -->
	<link rel="stylesheet" type="text/css" href="{{ asset('css/core.main.css') }}">
	<link rel="stylesheet" type="text/css" href="{{ asset('css/daygrid.main.css') }}">
	<link rel="stylesheet" type="text/css" href="{{ asset('css/timegrid.main.css') }}">
	<!-- selectpicker -->
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('css/scroller.bootstrap.min.css') }}">
	<!-- jqv map-->
