...
<div class="container">
  ...
  <tbody>
    <?php
      //Se realiza una consulta para traer todos los registros de la tabla de fabricantes
    ...
    <tr>
      ...
      <td><?php echo $row["nombre_fabricante"]; ?></td>
      <td><?php echo $row["direccion"]; ?></td>
      <td><?php echo $row["correo"]; ?></td>
      <?php
        $sql = "SELECT nombre FROM categoria_fabricante WHERE id = ".$row['categoria'];
