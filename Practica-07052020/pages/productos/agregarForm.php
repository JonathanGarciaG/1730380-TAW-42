                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" placeholder="Venta" id="venta" name="venta" required>
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group">
                        <label>Precio Compra*</label>
                        <input type="number" class="form-control" placeholder="Compra" id="compra" name="compra" required> 
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-8">
                      ...
                      <div class="form-group">
                        ...
                        <input type="textarea" class="form-control" placeholder="Descripción" id="desc" name="descripcion" required>
                      </div>
                    </div>
                  </div>
